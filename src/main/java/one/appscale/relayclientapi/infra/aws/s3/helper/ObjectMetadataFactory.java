...
public class ObjectMetadataFactory {
    public static ObjectMetadata csvNotifiableObjectMetadata(final String traceId,
                                                             final String email,
                                                             final CsvMetadata csvMetadata) {
        final ObjectMetadata objectMetadata = new ObjectMetadata();
        objectMetadata.setContentType("text/csv");
        final Map<String, String> userMetadata = csvMetadata.toUserMetadata(traceId, email).toMap();
